...
| **Input** | `{ name: string, description?: string, properties?: {...}, links?: {...}, defaults?: {...}, display?: { title?, subtitle?, formFields?, primaryProperties?, actions? }, browsable?: boolean, rollups?: {...}, parts_frozen_when?: {...}, expectedHash?: string, force?: boolean }` |
