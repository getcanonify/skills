...
[`DESIGN-SURFACE.md`](../../DESIGN-SURFACE.md#24-user-visible-string-ownership).
...
optionally `business_days` against a named `calendar` ObjectType — which MUST
declare `date` and `org_id` properties, see Recipe 6). Expressions
